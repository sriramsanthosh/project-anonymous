...
function Home(){
    ...
    <footer>
        <p className="author-sign"><span className="orange-color">Made with</span> <i class="fa-solid fa-heart"></i>&nbsp;<a className="author-profile-link" href="https://www.linkedin.com/in/sriramsanthosh/" target="_blank">Sriram&nbsp;Santhosh</a></p>
    </footer>
    </div>
}
